    ...
    <div class="modal-dialog modal-lg"  role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Asignar Presentación y Costos</h3>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group" >
                            <label for="suppPric">% De Descuento</label>
                            ...
                            <label for="suppPric">Cant. de Descuento</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h3>Descuentos Fecha</h3></div> <div class="col-md-6"><h4><input type="checkbox" ng-model="presentation.activateDsctoRange"> Activar</h4></div>
                </div>
